...
import sop.ce.gov.financeiro.domain.entidade.TipoDespesa;
import sop.ce.gov.financeiro.domain.exceptions.CantDeleteDespesa;
import sop.ce.gov.financeiro.domain.repositories.DespesaRepository;
import sop.ce.gov.financeiro.domain.repositories.TipoDespesaRepository;
